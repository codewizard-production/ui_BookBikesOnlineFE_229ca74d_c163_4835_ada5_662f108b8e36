            ...
            <List>
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => NavigateTo("/products1")} sx={{ height: 50 }}>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/Bikes1/list")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="BikesList">
                                    <GridView color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="BikesList" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        <ListItemButton onClick={() => NavigateTo("/products2/tiles")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Tiles">
                                    <AddLink color="primary" />
                                </Tooltip>
